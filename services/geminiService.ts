          ...
          parts: [
            {
              ...
              **필수 요구사항:**
              ...
              4. **후킹(Hooks):** 영상 시작 5초 안에 시청자가 절대 이탈하지 못하도록 자극적이고 궁금증을 유발하는 멘트를 3-5개 만드세요.
              5. **구조(Structure):** 일반적인 기승전결이 아닌, 유튜브에 최적화된 '떡상 구조' (강력한 후킹 -> 배경 설명 최소화 -> 빠른 전개 -> 반전/위기 -> 해소)를 제안하세요.
              6. **톤앤매너:** 분석적이지만 크리에이터에게 영감을 주는 열정적인 톤을 유지하세요.
              7. **정확성:** 자료에 명시되지 않은 내용은 추측하지 말고, 제공된 팩트만으로 구조를 만드세요.
